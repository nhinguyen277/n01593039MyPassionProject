...
namespace n01593039MyPassionProject.Controllers
{
    public class VolunteerController : Controller
    {
        ...
        public ActionResult List(string SearchKey = null)
        {
            ...
            //https://localhost:44328/api/volunteerdata/listvolunteers
            // use Http client to access the information

            HttpClient client = new HttpClient() { };
            //set the url
            string url = "https://localhost:44328/api/volunteerdata/listvolunteers";
        ...
        public ActionResult Details(int id)
        {
            ...
            //https://localhost:44328/api/volunteerdata/findvolunteer/{id}
            // use Http client to access the information

            HttpClient client = new HttpClient() { };
            //set the url
            string url = "https://localhost:44328/api/volunteerdata/findvolunteer/" + id;
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        public ActionResult New()
        {
            ...
            string url = "https://localhost:44328/api/groupdata/listgroups";
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        public ActionResult Create(Volunteer Volunteer)
        {
            ...
            //curl -H "Content-Type:application/json" -d @volunteer.json https://localhost:44328/api/volunteerdata/addvolunteer
            HttpClient client = new HttpClient() { };
            string url = "https://localhost:44328/api/volunteerdata/addvolunteer";
        ...
        public ActionResult Edit(int id)
        {
            ...
            url = "https://localhost:44328/api/groupdata/listgroups/";
        ...
        {
            GetApplicationCookie();//get token credentials   
            string url = "https://localhost:44328/api/volunteerdata/updatevolunteer/" + id;
            HttpClient client = new HttpClient() { };
            string jsonpayload = jss.Serialize(Volunteer);
            HttpContent content = new StringContent(jsonpayload);
            content.Headers.ContentType.MediaType = "application/json";
        ...
        public ActionResult Delete(int id)
        {
            ...
            string url = "https://localhost:44328/api/volunteerdata/deletevolunteer/" + id;
