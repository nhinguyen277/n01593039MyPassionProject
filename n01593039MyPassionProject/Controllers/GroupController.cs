...
namespace n01593039MyPassionProject.Controllers
{
    public class GroupController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            //https://localhost:44328/api/groupdata/listgroups
        ...
        public ActionResult Details(int id)
        {
            ...
            //https://localhost:44328/api/groupdata/findgroup/{id}
            // use Http client to access the information
            HttpClient client = new HttpClient() { };
            DetailsGroup ViewModel = new DetailsGroup();
            //set the url
            string url = "https://localhost:44328/api//groupdata/findgroup/" + id;
            HttpResponseMessage response = client.GetAsync(url).Result;
            ...
            url = "https://localhost:44328/api/volunteerdata/listvolunteersforgroups/" + id;
            ...
            url = "https://localhost:44328/api/activitydata/listactivitiesforgroup/" + id;
            response = client.GetAsync(url).Result;
        ...
        public ActionResult Create(Group Group)
        {
            ...
            //curl -H "Content-Type:application/json" -d @group.json https://localhost:44328/api/groupdata/addgroup 

            HttpClient client = new HttpClient() { };
            string url = "https://localhost:44328/api/groupdata/addgroup";
        ...
        {
            HttpClient client = new HttpClient() { };
            string url = "https://localhost:44328/api/groupdata/updategroup/" + id;
            string jsonpayload = jss.Serialize(Group);
            HttpContent content = new StringContent(jsonpayload);
            content.Headers.ContentType.MediaType = "application/json";
            HttpResponseMessage response = client.PostAsync(url, content).Result;
        ...
        {
            HttpClient client = new HttpClient() { };
            string url = "https://localhost:44328/api/groupdata/deletegroup/" + id;
